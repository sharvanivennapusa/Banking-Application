...
{
//Account Id
var num= document.drawamt.accid.value.trim();
   if (num == "")
   {
       document.getElementById("demo").innerHTML = "ID cant be empty";
       document.drawamt.accid.focus();
       return false;
   }
   else if(isNaN(num)){
...
<form name="drawamt" method="post" action="withdraw.jsp" onsubmit="return validate();">
<table style="width:30%">
<tr>
<tr><td colspan="2"><h2 align="center">Withdraw Amount</h2></td></tr>
<tr>
